  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-hero-glow px-4 py-10">
      <div className="w-full max-w-xl rounded-4xl border border-line bg-surface p-6 shadow-soft sm:p-8">
        ...
        <h1 className="mt-4 font-display text-3xl font-bold text-slate-950">
        ...
        <form action={changePasswordAction} className="mt-8 space-y-4">
          <div>
            ...
            <input
              ...
              required
              minLength={8}
              className="w-full rounded-3xl border border-line bg-white px-4 py-3 outline-none focus:border-primary"
            />
          </div>
