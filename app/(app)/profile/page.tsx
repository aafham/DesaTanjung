      ...
      <div className="grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="space-y-4">
          <Card className="border-slate-200 bg-slate-50/80">
            <p className="text-sm font-bold uppercase tracking-[0.14em] text-primary">Profile status</p>
            <h3 className="mt-2 font-display text-3xl font-bold leading-tight text-slate-950">
              {profile.phone_number ? "Details are ready" : "Finish your contact details"}
            </h3>
            <p className="mt-3 text-base text-slate-700">
              {profile.phone_number
                ? "Your phone number is saved, so the committee can contact you quickly when needed."
                : "Add your phone number so the committee can reach you quickly for payment and community updates."}
            </p>
          </Card>
